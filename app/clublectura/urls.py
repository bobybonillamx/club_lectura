...
urlpatterns = [
    ...
    path('libros/<int:book_id>/orden/', views.reorder_book, name='reorder_book'),
    path('libros/categorias/bulk/', views.bulk_assign_category, name='bulk_assign_category'),
    path('miembros/', views.members_list, name='members_list'),
    ...
    path('perfil/redes/nueva/', views.add_user_social_link, name='add_user_social_link'),
    path('perfil/redes/<int:link_id>/eliminar/', views.delete_user_social_link, name='delete_user_social_link'),
